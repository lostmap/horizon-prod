...
AWS_LOCATION = 'static'
AWS_S3_ENDPOINT_URL = 'https://localhost/ad74b43ed78b42d8b78c5c2c65881ab2:news'

#STATICFILES_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'
#MEDIA_URL = "https://localhost/news/static/"
#MEDIA_ROOT = MEDIA_URL
MEDIA_URL = 'https://localhost/ad74b43ed78b42d8b78c5c2c65881ab2:news/media/'
MEDIA_ROOT = MEDIA_ROOT
DEFAULT_FILE_STORAGE = 'openstack_dashboard.storage_backends.MediaStorage'  # <-- here is where we reference it
...
from openstack_dashboard.storage_backends import uploaded_filepath_custom

SUMMERNOTE_CONFIG = {

    'disable_attachment': False,
    'attachment_upload_to': uploaded_filepath_custom,
    #'attachment_storage_class': 'openstack_dashboard.storage_backends.MediaStorage'
